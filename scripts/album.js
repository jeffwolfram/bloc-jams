...
var setCurrentAlbum = function(album) {
  ...
  $albumTitle.text(album.title);
    ...
    loadRowListeners(songRows);
    
 };


/*
Re-write the function so that it Checks to see if a parent exists. If it doesn't, then show an alert that says "No parent found".
...
var loadRowListeners = function(songRows){
